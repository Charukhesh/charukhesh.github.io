    ...
    <header className="fixed inset-x-0 top-0 z-40 flex justify-center px-4 pt-4">
      <div className="flex w-full max-w-wide items-center justify-between rounded-full border border-border-soft bg-bg/80 px-5 py-3 backdrop-blur-md sm:px-6">
        ...
        <div className="flex items-center gap-3">
          <a href="mailto:ae22b028@smail.iitm.ac.in" className="hidden rounded-full border border-border px-4 py-2 font-mono text-sm text-ink-dim transition-colors hover:border-accent hover:text-accent sm:block">Email</a>
